...
As `xstate` is written in [TypeScript](TODO: link to TypeScript), strongly typing your statecharts is useful and encouraged. Consider this light machine example:
