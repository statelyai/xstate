...
Suppose we want to model a [Promise](TODO: link) as a state machine. First, install XState using NPM or Yarn:

```bash
npm install xstate --save
```

Then, in your project, import `Machine`, which is a factory function that creates a [state machine](TODO: link) or [statechart](TODO: link):
