      ...
      [
        {
          ...
          "parent": undefined,
          "sessionId": "x:0",
          "state": "{"value":"active","done":false,"context":{"cycle":"[Circular]"},"historyValue":{},"children":{},"timers":[],"tags":[]}",
  ...
  it('should handle circular structures in events', () => {
    ...
    expect(iframeMock.flushMessages()).toMatchInlineSnapshot(`
      [
        ...
        {
          "sessionId": "x:0",
          "state": "{"value":"active","done":false,"context":{},"historyValue":{},"children":{},"timers":[],"tags":[]}",
          "type": "service.state",
        },
      ]
    `);
      ...
      [
        {
          ...
          "parent": undefined,
          "sessionId": "x:0",
          "state": "{"value":"active","done":false,"context":{"map":"map","deep":{"map":"map"}},"historyValue":{},"children":{},"timers":[],"tags":[]}",
          "type": "service.register",
        },
        {
  ...
  it('should successfully serialize value with unsafe toJSON when serializer manages to replace it', () => {
    ...
    expect(iframeMock.flushMessages()).toMatchInlineSnapshot(`
      [
        ...
        {
          "sessionId": "x:0",
          "state": "{"value":{},"done":false,"context":{"value":{"unsafe":"[unsafe]"}},"historyValue":{},"children":{},"timers":[],"tags":[]}",
          "type": "service.state",
        },
      ]
    `);
