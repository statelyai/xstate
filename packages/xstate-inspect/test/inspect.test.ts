  ...
  it('should successfully serialize value with unsafe toJSON when serializer manages to replace it', () => {
    ...
    expect(iframeMock.flushMessages()).toMatchInlineSnapshot(`
      Array [
        ...
        Object {
          "sessionId": "x:7",
          "state": "{\\"value\\":{},\\"context\\":{\\"value\\":{\\"unsafe\\":\\"[unsafe]\\"}},\\"historyValue\\":{},\\"actions\\":[],\\"event\\":{\\"type\\":\\"UNKNOWN\\"},\\"_event\\":{\\"name\\":\\"UNKNOWN\\",\\"data\\":{\\"type\\":\\"UNKNOWN\\"},\\"$$type\\":\\"scxml\\",\\"type\\":\\"external\\"},\\"_sessionid\\":\\"x:7\\",\\"_initial\\":false,\\"changed\\":false,\\"transitions\\":[],\\"children\\":{}}",
          "type": "service.state",
        },
      ]
    `);
