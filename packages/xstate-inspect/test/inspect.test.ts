      ...
      [
        {
          ...
          "parent": undefined,
          "sessionId": "x:0",
          "state": "{"value":"active","status":{"status":"active"},"context":{"cycle":"[Circular]"},"historyValue":{},"children":{},"tags":[]}",
  ...
  it('should handle circular structures in events', () => {
    ...
    expect(iframeMock.flushMessages()).toMatchInlineSnapshot(`
      [
        ...
        {
          "sessionId": "x:0",
          "state": "{"value":"active","status":{"status":"active"},"context":{},"historyValue":{},"children":{},"tags":[]}",
          "type": "service.state",
        },
      ]
    `);
      ...
      [
        {
          ...
          "parent": undefined,
          "sessionId": "x:0",
          "state": "{"value":"active","status":{"status":"active"},"context":{"map":"map","deep":{"map":"map"}},"historyValue":{},"children":{},"tags":[]}",
          "type": "service.register",
        },
        {
  ...
  it('should successfully serialize value with unsafe toJSON when serializer manages to replace it', () => {
    ...
    expect(iframeMock.flushMessages()).toMatchInlineSnapshot(`
      [
        ...
        {
          "sessionId": "x:0",
          "state": "{"value":{},"status":{"status":"active"},"context":{"value":{"unsafe":"[unsafe]"}},"historyValue":{},"children":{},"tags":[]}",
          "type": "service.state",
        },
      ]
    `);
