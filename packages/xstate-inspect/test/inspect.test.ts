      ...
      [
        {
          ...
          "parent": undefined,
          "sessionId": "x:1",
          "state": "{"value":"active","status":"active","context":{"cycle":"[Circular]"},"historyValue":{},"children":{},"timers":[],"tags":[]}",
  ...
  it('should handle circular structures in events', () => {
    ...
    expect(iframeMock.flushMessages()).toMatchInlineSnapshot(`
      [
        ...
        {
          "sessionId": "x:3",
          "state": "{"value":"active","status":"active","context":{},"historyValue":{},"children":{},"timers":[],"tags":[]}",
          "type": "service.state",
        },
      ]
    `);
      ...
      [
        {
          ...
          "parent": undefined,
          "sessionId": "x:5",
          "state": "{"value":"active","status":"active","context":{"map":"map","deep":{"map":"map"}},"historyValue":{},"children":{},"timers":[],"tags":[]}",
          "type": "service.register",
        },
        {
  ...
  it('should successfully serialize value with unsafe toJSON when serializer manages to replace it', () => {
    ...
    expect(iframeMock.flushMessages()).toMatchInlineSnapshot(`
      [
        ...
        {
          "sessionId": "x:7",
          "state": "{"value":{},"status":"active","context":{"value":{"unsafe":"[unsafe]"}},"historyValue":{},"children":{},"timers":[],"tags":[]}",
          "type": "service.state",
        },
      ]
    `);
