...
describe('final states', () => {
  ...
  it.only('should deliver final outgoing events (from root exit action) to the parent before delivering the `xstate.done.actor.*` event', () => {
    const child = createMachine({
      initial: 'start',
      states: {
        start: {
