...
describe('invoke', () => {
  ...
  describe('parent to child', () => {
    ...
    it.skip('should communicate with the child machine (invoke on machine)', (done) => {
      const mainMachine = createMachine({
        ...
        states: {
          one: {
            entry2: ({ children }) => {
              // TODO: foo-child is invoked after entry2 is executed so it does not exist yet
    ...
    const machine = createMachine({
      ...
      states: {
        ...
        b: {
          ...
          entry2: ({ children, self }, enq) => {
            // TODO: invoke gets called after entry2 so children.foo does not exist yet
            enq.sendTo(
              children.foo,
