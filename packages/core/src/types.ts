...
export type InvokeCreator<
  ...
  TInputEvent extends EventObject = any, // keeping a slot for it here, but it's actually not used right now, we don't have means to validate the communication contract between actors
