...
> extends StateMeta<TContext, TEvent> {
  ...
  self: ActorRef<TEvent, State<TContext, TEvent>>;
}
...
export interface InvokeMeta<TSelfRef extends ActorRef<any, any>> {
  data: any;
...
> = (
  context: TContext,
  event: TEvent,
  meta: InvokeMeta<ActorRef<TEvent, State<TContext, TEvent>>>
) =>
